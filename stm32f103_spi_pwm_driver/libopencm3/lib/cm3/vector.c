...
#pragma weak hard_fault_handler = _hard_fault_handler
...
/* Those are defined only on CM3 or CM4 */
#if defined(__ARM_ARCH_7M__) || defined(__ARM_ARCH_7EM__)
#pragma weak mem_manage_handler = _mem_manage_handler
#pragma weak bus_fault_handler = _bus_fault_handler
#pragma weak usage_fault_handler = _usage_fault_handler
